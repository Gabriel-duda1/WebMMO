...
public class Personagem {
    ...
    public List<PersonagemSeguidor> getSeguindo() { return seguindo; }
    public void setSeguindo(List<PersonagemSeguidor> seguindo) { this.seguindo = seguindo; }

    public List<PersonagemSeguidor> getSeguidores() { return seguidores; }
    public void setSeguidores(List<PersonagemSeguidor> seguidores) { this.seguidores = seguidores; }
}